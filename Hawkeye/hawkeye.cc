                                     ...
                                     champsim::address victim_addr, access_type type)
{
  ...
  // Writebacks and other PC-less traffic were never seen by OPTgen, so the predictor has nothing trained for them. Install as cache-friendly rather than reading a table entry trained by an unrelated PC.
